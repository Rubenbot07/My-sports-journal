    ...
    return (
        <section className="flex flex-col">
            <section className="flex justify-center items-center md:items-stretch flex-col md:flex-row">
                <i className="p-8 md:bg-primary text-xl md:text-2xl flex items-center md:text-white text-center md:p-10 w-full md:w-2/4 ">
            ...
            <section className="grid grid-cols-1 md:grid-cols-4 text-white bg-black md:bg-white">
                <div className="text-3xl font-bold flex justify-center items-center md:text-5xl">
                    <h1 className="md:rotate-[-90deg] py-6 text-white md:text-primary">About Us</h1>
                </div>
            ...
            <section className=" text-white">
                <div className=" bg-primary px-6 py-4 md:p-10 lg:p-20 flex flex-col gap-6">
                    ...
                    <button className="bg-white text-primary p-2 text-2xl font-medium rounded-lg w-40 mx-auto">Join Now</button>
                </div>
            </section>
        </section>
    )
